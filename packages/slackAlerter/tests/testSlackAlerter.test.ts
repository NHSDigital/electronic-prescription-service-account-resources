        ...
        const expectedRequest = [
            "www.slack.com/webhook", 
            {
                body: JSON.stringify(populateCloudWatchAlertMessageContent({
                    ...
                    moreInfoUrl: "https://console.aws.amazon.com/cloudwatch/home?region=eu-west-2#alarm:alarmFilter=ANY;name=PSU%20-%20Test%20Alarm%201"
                    },
                )),
                headers: {
        ...
        const expectedRequest2 = [
            "www.slack.com/webhook", 
            {
                body: JSON.stringify(populateCloudWatchAlertMessageContent({
                    ...
                    oldState: ":black_circle: INSUFFICIENT_DATA",
                    newState: ":red_circle: ALARM",
                    moreInfoUrl: "https://console.aws.amazon.com/cloudwatch/home?region=eu-west-2#alarm:alarmFilter=ANY;name=PSU%20-%20Test%20Alarm%202"
                    },
                )),
                headers: {
                    "Content-Type": "application/json"
