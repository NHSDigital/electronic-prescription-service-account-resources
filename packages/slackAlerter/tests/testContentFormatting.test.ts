...
import { formatHeader, formatTrigger, formatState, formatMoreInfoUrl } from "../src/contentFormatting"
...
describe("formatMoreInfoUrl", () => {
    it("returns a correctly formatted url when called", () => {
        const expected = "https://console.aws.amazon.com/cloudwatch/home?region=eu-west-2#alarm:alarmFilter=ANY;name=PSU%20-%20Test%20Alarm"
