...
export class Functions extends Construct {
  ...
  public constructor(scope: Construct, id: string, props: FunctionsProps){
    ...
    const decryptSecretsKMSKeyPolicy = ManagedPolicy.fromManagedPolicyArn(
      this,
      "DecryptSecretsKMSKeyPolicyImport",
      decryptSecretsKMSKeyPolicyImport
    )
    // Resources
    ...
    const reportAlertSuppressionsLambda = new TypescriptLambdaFunction(this, "ReportAlertSuppressionsLambda", {
      ...
      additionalPolicies: [readAlertSuppressionsPolicy, decryptSecretsKMSKeyPolicy],
